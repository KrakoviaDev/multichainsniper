...
## CACHE
keyToPath['es_cache_fielddata_evictions'] = "nodes.%s.indices.fielddata.evictions"
keyToPath['es_cache_fielddata_size'] = "nodes.%s.indices.fielddata.memory_size_in_bytes"
keyToPath['es_cache_filter_evictions'] = "nodes.%s.indices.filter_cache.evictions"
keyToPath['es_cache_filter_size'] = "nodes.%s.indices.filter_cache.memory_size_in_bytes"
...
## GC
keyToPath['es_gc_young_time'] = "nodes.%s.jvm.gc.collectors.young.collection_time_in_millis"
keyToPath['es_gc_young_count'] = "nodes.%s.jvm.gc.collectors.young.collection_count"
keyToPath['es_gc_old_time'] = "nodes.%s.jvm.gc.collectors.old.collection_time_in_millis"
keyToPath['es_gc_old_count'] = "nodes.%s.jvm.gc.collectors.old.collection_count"
